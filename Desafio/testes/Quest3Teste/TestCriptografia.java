 ...
 *Classe responsável pelos testes da classe Criptografia.
 */
public class TestCriptografia {
	...
	/**
	 * Método responsável em verificar se a frase criptografada que é retornada, realmente está criptografada de forma correta.
	 */
	@Test
